...
const TemplateItem = ({ title, id }) => {
  ...
  return (
    <div className="Template flex w-[240px] min-w-[240px] p-[12px] flex-col gap-[6px] rounded-[12px] border-[1px] bg-[var(--Gray-50,_#F5F5F6)] [box-shadow:0px] shadow-custom">
      <div className="title flex-[1_0_0] text-[16px] ml-[8px] font-[Pretendard] font-semibold not-italic leading-[24px] text-left self-stretch text-[#414149]">
        {title}
      </div>
      ...
      <button
        className="plus_button flex p-[6.8px] justify-center items-center gap-[4px] self-stretch rounded-[8px] bg-[var(--Primary-500,_#24A3B6)] text-white"
        onClick={() => nav("/new")}
      >
        +
      </button>
